...
#define SERVER_CMD_NUM_INT          16                                      // number internal server commands
...
#define SERVER_AUTO_SYNC_START      GET_CMD(0xfa,sizeof(client_data64))     // start auto-sync with given trigger delay (data_0) & phase (data_1), return ACK/NACK
#define SERVER_AUTO_SYNC_STOP       GET_CMD(0xfb,sizeof(client_data64))     // stop auto-sync and set trigger delay & phase, return with data_0 = sync_time
#define SERVER_TEST                 GET_CMD(0xff,sizeof(client_data32))     // test command
...
#define SERVER_CMD_LIST        {SERVER_NONE,SERVER_ACK,SERVER_NACK,SERVER_RESET,SERVER_SHUTDOWN,\
                    ...
                    SERVER_GET_STATUS_FULL,SERVER_RSP_STATUS_FULL,SERVER_GET_STATUS,SERVER_RSP_STATUS,SERVER_GET_STATUS_IRQ,SERVER_RSP_STATUS_IRQ,SERVER_TEST,\
