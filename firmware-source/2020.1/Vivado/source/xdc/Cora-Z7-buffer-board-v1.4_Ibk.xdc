...
## created 29/7/2022 by Andi vor FPGA_buffer_board v1.4
## modified 15/05/2024 for Innsbruck buffer board v1.4 by Andi
...
set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports {led_green_0[0]}]
set_property -dict { PACKAGE_PIN N15   IOSTANDARD LVCMOS33 } [get_ports {led_red_0[0]}]
set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports {led_blue_0[0]}]
...
# v1.3: single-ended clock input LVCMOS 3.3V
#set_property -dict {PACKAGE_PIN U18 IOSTANDARD LVCMOS33} [get_ports clk_in1_0]
# v1.4: differential clock input LVDS 2.5V
#set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { bus_en_0[1] }]
#set_property -dict { PACKAGE_PIN W19   IOSTANDARD LVCMOS33 } [get_ports { bus_strb_0[1] }]
set_property -dict { PACKAGE_PIN Y17   IOSTANDARD LVCMOS33 } [get_ports { clk_out_0 }]
set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVDS_25 } [get_ports {clk_in1_p_0} ]
set_property -dict { PACKAGE_PIN U19   IOSTANDARD LVDS_25 } [get_ports {clk_in1_n_0} ]
...
set_property -dict { PACKAGE_PIN W14   IOSTANDARD LVCMOS33 } [get_ports { bus_addr_1_0[0] }]
set_property -dict { PACKAGE_PIN Y14   IOSTANDARD LVCMOS33 } [get_ports { bus_addr_1_0[1] }]
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33 } [get_ports { bus_addr_1_0[2] }]
set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports { bus_addr_1_0[3] }]
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { bus_addr_1_0[4] }]
set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports { bus_addr_1_0[5] }]
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { bus_addr_1_0[6] }]
set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33 } [get_ports { bus_addr_1_0[7] }]
...
set_property -dict { PACKAGE_PIN F17   IOSTANDARD LVCMOS33 } [get_ports { bus_en_0[0] }]
set_property -dict { PACKAGE_PIN J19   IOSTANDARD LVCMOS33 } [get_ports { bus_strb_0[0] }]
set_property -dict { PACKAGE_PIN K17   IOSTANDARD LVCMOS33 } [get_ports { bus_data_0[0] }]
set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports { bus_data_0[1] }]
set_property -dict { PACKAGE_PIN N16   IOSTANDARD LVCMOS33 } [get_ports { bus_data_0[2] }]
set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33 } [get_ports { bus_data_0[3] }]
...
set_property -dict {PACKAGE_PIN B20 IOSTANDARD LVCMOS33} [get_ports {bus_data_0[6]}]
set_property -dict {PACKAGE_PIN C20 IOSTANDARD LVCMOS33} [get_ports {bus_data_0[7]}]
set_property -dict {PACKAGE_PIN B19 IOSTANDARD LVCMOS33} [get_ports {bus_data_0[5]}]
set_property -dict {PACKAGE_PIN A20 IOSTANDARD LVCMOS33} [get_ports {bus_data_0[4]}]
...
set_property -dict {PACKAGE_PIN U14 IOSTANDARD LVCMOS33} [get_ports {bus_addr_0_0[0]}]
set_property -dict {PACKAGE_PIN V13 IOSTANDARD LVCMOS33} [get_ports {bus_addr_0_0[1]}]
set_property -dict {PACKAGE_PIN T14 IOSTANDARD LVCMOS33} [get_ports {bus_addr_0_0[2]}]
set_property -dict {PACKAGE_PIN T15 IOSTANDARD LVCMOS33} [get_ports {bus_addr_0_0[3]}]
set_property -dict {PACKAGE_PIN V17 IOSTANDARD LVCMOS33} [get_ports {bus_addr_0_0[4]}]
set_property -dict {PACKAGE_PIN V18 IOSTANDARD LVCMOS33} [get_ports {bus_addr_0_0[5]}]
set_property -dict {PACKAGE_PIN R17 IOSTANDARD LVCMOS33} [get_ports {bus_addr_0_0[6]}]
set_property -dict {PACKAGE_PIN R14 IOSTANDARD LVCMOS33} [get_ports {bus_addr_0_0[7]}]
set_property -dict {PACKAGE_PIN N18 IOSTANDARD LVCMOS33} [get_ports {ext_out_0[2]}]
...
set_property -dict {PACKAGE_PIN R16 IOSTANDARD LVCMOS33} [get_ports {bus_data_0[15]}]
set_property -dict {PACKAGE_PIN U12 IOSTANDARD LVCMOS33} [get_ports {bus_data_0[14]}]
set_property -dict {PACKAGE_PIN U13 IOSTANDARD LVCMOS33} [get_ports {bus_data_0[13]}]
set_property -dict {PACKAGE_PIN V15 IOSTANDARD LVCMOS33} [get_ports {bus_data_0[12]}]
set_property -dict {PACKAGE_PIN T16 IOSTANDARD LVCMOS33} [get_ports {bus_data_0[11]}]
set_property -dict {PACKAGE_PIN U17 IOSTANDARD LVCMOS33} [get_ports {bus_data_0[10]}]
set_property -dict {PACKAGE_PIN T17 IOSTANDARD LVCMOS33} [get_ports {bus_data_0[9]}]
set_property -dict {PACKAGE_PIN R18 IOSTANDARD LVCMOS33} [get_ports {bus_data_0[8]}]
#sync out/en/in
set_property -dict {PACKAGE_PIN P18 IOSTANDARD LVCMOS33} [get_ports {ext_in_0[2]}]
set_property -dict {PACKAGE_PIN N17 IOSTANDARD LVCMOS33} [get_ports {ext_in_0[1]}]
set_property -dict {PACKAGE_PIN M17 IOSTANDARD LVCMOS33} [get_ports {ext_in_0[0]}]
set_property -dict {PACKAGE_PIN L17 IOSTANDARD LVCMOS33} [get_ports {led_green_0[1]}]
set_property -dict {PACKAGE_PIN H17 IOSTANDARD LVCMOS33} [get_ports {led_red_0[1]}]
set_property -dict {PACKAGE_PIN H18 IOSTANDARD LVCMOS33} [get_ports {ext_out_0[0]}]
set_property -dict {PACKAGE_PIN G18 IOSTANDARD LVCMOS33} [get_ports {led_blue_0[1]}]
set_property -dict {PACKAGE_PIN L20 IOSTANDARD LVCMOS33} [get_ports {ext_out_0[1]}]
