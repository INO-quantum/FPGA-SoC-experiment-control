...
#set_clock_groups -physically_exclusive -group [get_clocks -include_generated_clocks clkfbout_design_1_clk_wiz_2_0] -group [get_clocks -include_generated_clocks clkfbout_design_1_clk_wiz_2_0_1]
#set_clock_groups -physically_exclusive -group [get_clocks -include_generated_clocks clk_bus_design_1_clk_wiz_2_0] -group [get_clocks -include_generated_clocks clk_bus_design_1_clk_wiz_2_0_1]
#set_clock_groups -physically_exclusive -group [get_clocks -include_generated_clocks clk_strb0_design_1_clk_wiz_2_0] -group [get_clocks -include_generated_clocks clk_strb0_design_1_clk_wiz_2_0_1]
#set_clock_groups -physically_exclusive -group [get_clocks -include_generated_clocks clk_strb1_design_1_clk_wiz_2_0] -group [get_clocks -include_generated_clocks clk_strb1_design_1_clk_wiz_2_0_1]
#set_clock_groups -physically_exclusive -group [get_clocks -include_generated_clocks clk_out_design_1_clk_wiz_2_0] -group [get_clocks -include_generated_clocks clk_out_design_1_clk_wiz_2_0_1]
#set_clock_groups -asynchronous -group [get_clocks clk_fpga_1] -group [get_clocks clk_bus_design_1_clk_wiz_2_0]
#set_clock_groups -asynchronous -group [get_clocks clk_fpga_1] -group [get_clocks clk_bus_design_1_clk_wiz_2_0_1]
#set_clock_groups -asynchronous -group [get_clocks clk_fpga_1] -group [get_clocks clk_fpga_0]
#set_clock_groups -asynchronous -group [get_clocks clk_bus_design_1_clk_wiz_2_0] -group [get_clocks clk_fpga_1]
#set_clock_groups -asynchronous -group [get_clocks clk_bus_design_1_clk_wiz_2_0_1] -group [get_clocks clk_fpga_1]
#set_clock_groups -asynchronous -group [get_clocks clk_fpga_0] -group [get_clocks clk_fpga_1]
#set_clock_groups -asynchronous -group [get_clocks clk_strb0_design_1_clk_wiz_2_0] -group [get_clocks clk_fpga_1]
#set_clock_groups -asynchronous -group [get_clocks clk_strb0_design_1_clk_wiz_2_0_1] -group [get_clocks clk_fpga_1]
#set_clock_groups -asynchronous -group [get_clocks clk_strb1_design_1_clk_wiz_2_0] -group [get_clocks clk_fpga_1]
#set_clock_groups -asynchronous -group [get_clocks clk_strb1_design_1_clk_wiz_2_0_1] -group [get_clocks clk_fpga_1]
#set_clock_groups -asynchronous -group [get_clocks clk_fpga_1] -group [get_clocks clk_strb0_design_1_clk_wiz_2_0]
#set_clock_groups -asynchronous -group [get_clocks clk_fpga_1] -group [get_clocks clk_strb0_design_1_clk_wiz_2_0_1]
#set_clock_groups -asynchronous -group [get_clocks clk_fpga_1] -group [get_clocks clk_strb1_design_1_clk_wiz_2_0]
#set_clock_groups -asynchronous -group [get_clocks clk_fpga_1] -group [get_clocks clk_strb1_design_1_clk_wiz_2_0_1]
...
#set_clock_groups -asynchronous -group [get_clocks clk_bus_design_1_clk_wiz_2_0_1] -group [get_clocks clk_det_design_1_clk_wiz_1_0]
#set_clock_groups -asynchronous -group [get_clocks clk_fpga_1] -group [get_clocks clk_det_design_1_clk_wiz_1_0]
#set_clock_groups -asynchronous -group [get_clocks clk_bus_design_1_clk_wiz_2_0] -group [get_clocks clk_det_design_1_clk_wiz_1_0_1]
#set_clock_groups -asynchronous -group [get_clocks clk_fpga_1] -group [get_clocks clk_det_design_1_clk_wiz_1_0_1]
#set_clock_groups -asynchronous -group [get_clocks clk_det_design_1_clk_wiz_1_0] -group [get_clocks clk_fpga_1]
#set_clock_groups -asynchronous -group [get_clocks clk_det_design_1_clk_wiz_1_0_1] -group [get_clocks clk_fpga_1]

#added by Andi to fix a timing issue:
#TODO: how to define constraints inside cdc module? this would fix quite some problems here?
#set_clock_groups -asynchronous -group [get_clocks clk_bus_design_1_clk_wiz_2_0] -group [get_clocks clk_strb0_design_1_clk_wiz_2_0]
#set_clock_groups -asynchronous -group [get_clocks clk_bus_design_1_clk_wiz_2_0_1] -group [get_clocks clk_strb0_design_1_clk_wiz_2_0_1]
#set_clock_groups -asynchronous -group [get_clocks clk_bus_design_1_clk_wiz_2_0_1] -group [get_clocks clk_fpga_0]
#set_clock_groups -asynchronous -group [get_clocks clk_bus_design_1_clk_wiz_2_0_1] -group [get_clocks clk_fpga_0]
#set_clock_groups -asynchronous -group [get_clocks clk_fpga_0] -group [get_clocks clk_strb0_design_1_clk_wiz_2_0]
...
#set_clock_groups -asynchronous -group [get_clocks clk_strb0_design_1_clk_wiz_2_0_1] -group [get_clocks clk_fpga_0]
#set_clock_groups -asynchronous -group [get_clocks clk_strb1_design_1_clk_wiz_2_0_1] -group [get_clocks clk_fpga_0]
#set_clock_groups -asynchronous -group [get_clocks clk_fpga_0] -group [get_clocks clk_strb0_design_1_clk_wiz_2_0_1]
#set_clock_groups -asynchronous -group [get_clocks clk_fpga_0] -group [get_clocks clk_strb1_design_1_clk_wiz_2_0_1]
