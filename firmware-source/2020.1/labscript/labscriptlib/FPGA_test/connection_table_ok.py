...
if False: # PulseBlaster as parent device
    from labscript_devices import PulseBlaster

    pb0     = PulseBlaster.PulseBlaster(name='PulseBlaster_0', board_number=0)
    pb0_trg = Trigger(name='pb0_trg', parent_device=pb0.direct_outputs, connection='flag 0', trigger_edge_type='rising')
    pb0_ch1 = DigitalOut(name='pb0_ch1', parent_device=pb0.direct_outputs, connection='flag 1')
else:
    pb0     = None
    pb0_trg = None
    pb0_ch1 = None
...
if False:
    ...
    NI_DAQmx_internal_clock('NI_internal_clock', board_number=0)
    ClockLine('clock_0', NI_internal_clock.pseudoclock, 'do00')
    NI_PXIe_6535('NI_board0', clock_0, clock_terminal='PFI0', MAX_name='NI_PXIe_6565/slot2')
    NI_PXIe_6738('NI_board1', clock_0, clock_terminal='PFI0', MAX_name='NI_PXIe_6768/slot3')
    NI_PXIe_6738('NI_board2', clock_0, clock_terminal='PFI0', MAX_name='NI_PXIe_6738/slot4')

    #DigitalOut('test_do0', NI_internal_clock.direct_DO, 'do00')
    #DigitalOut('test_do1', NI_internal_clock.direct_DO, 'do04')

    #AnalogOut(name='test_ao0', parent_device=NI_internal_clock.direct_AO, connection='ao0')
    #AnalogOut(name='test_ao1', parent_device=NI_internal_clock.direct_AO, connection='ao4')
...
if False:
    ...
    DigitalChannels(name='DO_QRF_1', parent_device=primary, connection='0x38', rack=0, max_channels=16, clockline=('QRF',True))
    ...
    MOGLabs_QRF(name='QRF_0', parent_device=DO_QRF_1, addr='192.168.1.190', port=7802)
...
if primary is not None:
    ...
    AnalogOut     (name='IR_AOM_no2_percent', parent_device=AO0, connection='0x2', default_value = 1.0,
...
if primary is not None:
    ...
    DigitalOut     (name='MOT_IGBT_no0per1_on', parent_device=DO0, connection=0, default_value=1)
    DigitalOut     (name='FB_Helmholtz_no0per2_on', parent_device=DO0, connection=1, default_value=0)
    ...
    DigitalChannels(name='DO2', parent_device=board_alt, connection='0x40', rack=0, max_channels=16)
