...
##############################################################################################################
# ATTENTION: this part must be the same in connection_table.py!!!!
...
if True:
    for i in range(1):
        ...
        # for 16 bits voltage resolution and more than 2^16 samples not every sample can change voltage.
        t += dt
