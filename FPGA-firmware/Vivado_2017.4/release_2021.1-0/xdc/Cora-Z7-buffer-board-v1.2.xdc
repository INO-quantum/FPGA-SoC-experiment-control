...
## created 12/3/2020 by Andi vor FPGA_buffer_board v1.2
...
set_property -dict {PACKAGE_PIN N15 IOSTANDARD LVCMOS33} [get_ports {leds_out_0[0]}]
set_property -dict {PACKAGE_PIN L14 IOSTANDARD LVCMOS33} [get_ports {leds_out_0[1]}]
...
set_property -dict {PACKAGE_PIN F17 IOSTANDARD LVCMOS33} [get_ports {bus_addr_0[6]}]
set_property -dict {PACKAGE_PIN J19 IOSTANDARD LVCMOS33} [get_ports {bus_addr_0[5]}]
set_property -dict {PACKAGE_PIN K17 IOSTANDARD LVCMOS33} [get_ports {bus_addr_0[4]}]
set_property -dict {PACKAGE_PIN L16 IOSTANDARD LVCMOS33} [get_ports {bus_addr_0[3]}]
set_property -dict {PACKAGE_PIN N16 IOSTANDARD LVCMOS33} [get_ports {bus_addr_0[2]}]
set_property -dict {PACKAGE_PIN P14 IOSTANDARD LVCMOS33} [get_ports {bus_addr_0[1]}]
...
set_property -dict {PACKAGE_PIN C20 IOSTANDARD LVCMOS33} [get_ports trg_stop_0]
set_property -dict {PACKAGE_PIN F19 IOSTANDARD LVCMOS33} [get_ports trg_start_0]
set_property -dict {PACKAGE_PIN F20 IOSTANDARD LVCMOS33} [get_ports trg_out_0]
#set_property -dict {PACKAGE_PIN B19 IOSTANDARD LVCMOS33} [get_ports {bus_addr_0[0]}]
set_property -dict {PACKAGE_PIN B19 IOSTANDARD LVCMOS33} [get_ports bus_strb_0]
set_property -dict {PACKAGE_PIN A20 IOSTANDARD LVCMOS33} [get_ports {bus_addr_0[0]}]
...
#clk_in1_0 at pins N18 = ck_IO08 or U18 = JA[7]
#set_property -dict {PACKAGE_PIN N18 IOSTANDARD LVCMOS33} [get_ports clk_in1_0]
#set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { ck_io9 }]; #IO_L8N_T1_AD10N_35 Sch=ck_io[9]
#set_property -dict { PACKAGE_PIN U15   IOSTANDARD LVCMOS33 } [get_ports { ck_io10 }]; #IO_L11N_T1_SRCC_34 Sch=ck_io[10]
...
set_property -dict {PACKAGE_PIN N17 IOSTANDARD LVCMOS33} [get_ports sync_en_0]
set_property -dict {PACKAGE_PIN M17 IOSTANDARD LVCMOS33} [get_ports sync_in_0]
set_property -dict { PACKAGE_PIN L17   IOSTANDARD LVCMOS33 } [get_ports { sync_mon_0 }]; #IO_L11N_T1_SRCC_35 Sch=ck_io[37]
#set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { ck_io38 }]; #IO_L13N_T2_MRCC_35 Sch=ck_io[38]
set_property -dict {PACKAGE_PIN H18 IOSTANDARD LVCMOS33} [get_ports bus_enable_n_0]
set_property -dict {PACKAGE_PIN G18 IOSTANDARD LVCMOS33} [get_ports {leds_out_0[2]}]
set_property -dict {PACKAGE_PIN L20 IOSTANDARD LVCMOS33} [get_ports {leds_out_0[3]}]
